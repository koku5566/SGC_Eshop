...
?>
             ...
             <div class="container-fluid" style="width:80%">
                ...
                <select id="animal" name="dra">
                    <option value="dragon1">Dragon</option>
                    <option value="dragon2">龙</option>
                    <option value="dragon3">ドラゴン</option>
                    <option value="dragon4">Дракон</option>
                    <input type="image" src="https://www.freeiconspng.com/thumbs/edit-icon-png/edit-new-icon-22.png" class = "imgset"> 
                </select>
