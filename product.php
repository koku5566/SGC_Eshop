                    ...
                    <div class="row mb-3" style="background-color:white;">
                        ...
                        <div class="col-xl-7 col-md-6 mb-6">
                            ...
                            <div class="row mb-4" id="ShippingOptionDiv">
								<div class="col-12">
                                    <span style="font-size:18pt;font-weight: bold;"><?php echo($i_product_self_collect == 0 ? "" :  "This is a product able to make self collect"); ?></span>
                                </div>
                                <div class="col-12">
                                    <span style="font-size:18pt;font-weight: bold;"><?php echo($i_product_virtual == 0 ? "" :  "This is a virtual product without shipping ment"); ?></span>
                                </div>
                            </div>
                            <!-- Price -->
