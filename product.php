							...
							<div class="row">
								<?php 
									...
									if (mysqli_num_rows($result_shop) > 0) {
										...
										<div class=\"col-xl-9 col-md-8 sidebar-brand-text\" style=\"font-size: 1.5rem;font-weight: bold;\">
											<b>$shop_name</b>
											<a href=\"shopDetails.php?id=$shop_id\" class=\"btn btn-primary\" style=\"width:inherit;\">
