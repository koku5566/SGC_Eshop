...
?>
    ...
    <img style="height: 86px;padding-top: 0px;margin-left: 11px;margin-top: 0px;width: 431.1625px;" src="segi kl.png" />
    ...
    border: 1.5px solid var(--bs-gray-600);box-shadow: 4px 4px rgba(108,117,125,0.3);">
