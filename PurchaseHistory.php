...
?>
    ...
    <div style="padding-left: 59px;padding-top: 40px;">
        <div>
            ...
            margin-left: 0px;background: rgba(13,110,253,0);color: var(--bs-blue);border-style: none;border-color: var(--bs-body-bg);text-decoration: underline;">
    ...
    <div style="height: 249px;width: 1117.2px;margin-left: 135px;box-shadow: 4px 4px rgba(108,117,125,0.3);border: 1px solid var(--bs-gray-600);">
