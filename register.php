                            ...
                            <form class="user" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
										...
										<input required type="password" name="password" class="form-control form-control-user" id="inputPassword" maxlength="50" pattern="(?=.*\d).{8,}" placeholder="At least 8 characters long" title="Must be at least 8 characters long">
                                    </div>
                                    <div class="col-sm-6">
