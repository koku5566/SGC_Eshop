...
<div class="modal fade" id="courieroptionModal" tabindex="-1" role="dialog" aria-labelledby="courieroptionModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    ?>
        ...
        <div class="modal-footer">
        <a href="userEditAddress.php"><button class="btn btn-primary text-center" type="button" style="text-align: right;background: #A71337;width: 122.95px;float: right;" name="submitAddress">Manage Address</button></a>
