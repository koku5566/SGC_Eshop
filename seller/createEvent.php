    ...
    <div class="d-lg-block d-xl-block d-xxl-block" style="margin-top: 30px;">
        ...
        <form action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "POST" enctype="multipart/form-data">
            ...
            <div style="margin-top: 61px;text-align: center;margin-bottom: 61px;">
                ...
                <input class="btn btn-outline-primary" type="submit" name="eRegister" style="margin-left: 5px;margin-right: 5px;background: rgb(163, 31, 55);color: rgb(255,255,255);">Submit</button></div>
            </div>
        </form>
    </div>
