                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $srow['status']; ?><br><?php if($srow['status'] =='Shipped'){ echo 'Tracking Number: ',$srow['tracking_number'] ;?><button onclick="linkTrack('PL328056441873')">TRACK</button><?php }?></td>
                                    </tr>
                                <?php 
                                }
                                ?>
