                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $srow['status']; ?><br><?php if($srow['status'] =='Shipped'){ echo 'Tracking Number: ',$srow['tracking_number'] ;?><input type="text" id="TrackNo" value="<?php $srow['tracking_number']?>"><button class="btn btn-info btn-sm" onclick="linkTrack()">TRACK</button><?php }?></td>
                                    </tr>
                                <?php 
                                }
                                ?>
