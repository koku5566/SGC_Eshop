                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-2">
                                                            <?php if ($arow['order_status'] == 'Paid' && $arow['delivery_method'] == 'standard-delivery') { ?><a class="btn btn-primary btn-sm" href="shippingCheckDetails.php?order_id=<?php echo $arow['invoice_id']; ?>">Arrange Shipment</a>
