                                                    ...
                                                    else if($status == 2)
                                                    {
                                                        echo ("
                                                                <div class=\"row\">
                                                                    ...
                                                                    <div class=\"col-xl-2 col-lg-2 col-sm-12\">
                                                                        <a class=\"btn btn-outline-primary\" style=\"border:none;width:100%;\" href=\"?requestSection=".$row['promotionID']."\" ><i class=\"fa fa-eye \" style=\"padding:0 10px;\" aria-hidden=\"true\"></i>View</a>                                                                    </div>
                                                                    <div class=\"col-xl-2 col-lg-2 col-sm-12\">
                                                                        <a class=\"btn btn-outline-danger\" style=\"border:none;width:100%;\" href=\"?delete=".$row['promotionID']."\" ><i class=\"fa fa-trash \" style=\"padding:0 10px;\" aria-hidden=\"true\"></i>Delete</a>
                                                                    </div>
                                                                </div>
