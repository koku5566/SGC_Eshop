                                    ...
                                    <form action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-2 col-sm-12">
                                                ...
                                                <div class="col-xl-10 col-lg-10 col-sm-12"><small class="text-muted m-2">This image should be landscape. Recommended image size in ratio 16:9. (Example: 1920 x 1080)</small>
</div>
                                        </div> 
