                ...
                <div class="col-12">
                    <table id="transactionTable">
                        ...
                        <tbody>
                            ...
                            $sqlpayment = "SELECT  * FROM `payments` INNER JOIN (SELECT invoice_id, shop_id FROM productTransaction GROUP BY invoice_id, shop_id)t on payments.invoice_id = t.invoice_id WHERE t.shop_id = '$_SESSION[uid]' ";
