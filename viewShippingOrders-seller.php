      ...
      <div class="container justify-content-center">
        <div class="row">
          ...
          <div class="filter-search col-6">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control input-text" placeholder="Search order" aria-label="Recipient's username" aria-describedby="basic-addon2">
        ...
        <div class="order-list-body pt-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-1"><img src="https://www.w3schools.com/images/w3schools_green.jpg" alt="W3Schools.com"></div>
